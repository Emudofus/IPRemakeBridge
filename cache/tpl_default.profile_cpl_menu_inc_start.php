...
<tr>
	<td id="var_width" width="160" valign="top" align="left" style="padding-right: 7px;">
		<div id="quick_links_profile2" style="padding-top: 5px; display: none; margin-left: 0px; text-align: left; position: relative; float: left;"><a href="#" onclick="ShowHide('quick_links_profile', 'quick_links_profile2', 'quick_links_profile'); setWidth('var_width', 160); setWidth('full_width', 'auto'); return false;" title="<?php echo isset($this->vars['L_SHOW']) ? $this->vars['L_SHOW'] : $this->lang('L_SHOW'); ?> <?php echo isset($this->vars['L_CPL_NAV']) ? $this->vars['L_CPL_NAV'] : $this->lang('L_CPL_NAV'); ?>"><img src="<?php echo isset($this->vars['IMG_NAV_MENU_APPLICATION']) ? $this->vars['IMG_NAV_MENU_APPLICATION'] : $this->lang('IMG_NAV_MENU_APPLICATION'); ?>" alt="<?php echo isset($this->vars['L_SHOW']) ? $this->vars['L_SHOW'] : $this->lang('L_SHOW'); ?> <?php echo isset($this->vars['L_CPL_NAV']) ? $this->vars['L_CPL_NAV'] : $this->lang('L_CPL_NAV'); ?>" /></a></div>
