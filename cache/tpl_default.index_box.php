...
?>
	...
	<td class="row1h<?php echo isset($forumrow_item['LINK_CLASS']) ? $forumrow_item['LINK_CLASS'] : ''; ?> row-forum" width="100%" colspan="<?php echo isset($forumrow_item['INC_SPAN']) ? $forumrow_item['INC_SPAN'] : ''; ?>" onclick="window.location.href='<?php echo isset($forumrow_item['U_VIEWFORUM']) ? $forumrow_item['U_VIEWFORUM'] : ''; ?>'">
